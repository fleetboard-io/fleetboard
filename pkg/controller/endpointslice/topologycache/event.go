...
const (
	...
	InsufficientNodeInfo       = "Insufficient Node information: allocatable CPU or zone not " +
		"specified on one or more nodes"
	NodesReadyInOneZoneOnly               = "Nodes only ready in one zone"
	InsufficientNumberOfEndpoints         = "Insufficient number of endpoints"
	MinAllocationExceedsOverloadThreshold = "Unable to allocate minimum required endpoints to each zone without " +
		"exceeding overload threshold"
)
...
// EventType, Reason, and Message fields are equivalent to the v1.Event fields -
// https://pkg.go.dev/k8s.io/api/core/v1#Event.
